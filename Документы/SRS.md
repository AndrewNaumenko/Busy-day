...
Для просмотра запланированных задач необходимо выбрать пункт меню «Задачи», рисунок 2.3.![рисунок 2.3](https://github.com/AndrewNaumenko/Busy-day/tree/master/Мокапы/Task.png)  Если пользователю нужно добавить новую задачу, потребуется нажать на изображение «+» и ввести требуемые данные (рисунок 2.4).
